(function (window, undefined) {
    ...
    MapsLib.prototype.doSearch = function () {
        ...
        var tempWhereClause = [];
        //TODO: standardize these so they overlap whenever possible
        if ( $("#cbType1").is(':checked')) tempWhereClause.push("ROW");
        if ( $("#cbType2").is(':checked')) tempWhereClause.push("Structure");
        if ( $("#cbType3").is(':checked')) tempWhereClause.push("Station");
        if ( $("#cbType4").is(':checked')) tempWhereClause.push("Postcard");
        if ( $("#cbType5").is(':checked')) tempWhereClause.push("image");
        if ( $("#cbType6").is(':checked')) tempWhereClause.push("postcard");
